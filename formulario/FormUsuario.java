...
import pesquisa.FormPesquisaFunc;
...
public class FormUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btPesquisarFuncionario.setText("Pesquisar");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(edFuncionario, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(btPesquisarFuncionario, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void btPesquisarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarFuncionarioActionPerformed
        FormPesquisaFunc form = new FormPesquisaFunc(this, true);
        form.setVisible(true);
        
        f = form.getFuncionario();
        edFuncionario.setText(f.getNomeCompleto());
    ...
    public void preencherTabela() {
        ...
        for (Usuario u : lista) {
            modelo.addRow(new Object[]{u.getIdUsuario(), u.getFuncionario().getNomeCompleto(), u.getEmail(), u.getUserName(), u.getTelefone()});
        }
    }

    public void buscarUsuarioId(int id,Usuario us) {
        UsuarioDao udao = new UsuarioDao();
        List<Usuario> lista = udao.listarTodos(id); 
        for (Usuario u : lista) {
            us = u;
        }
    }
